...
function renderUI(obj) {
		...
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				...
				'<div class="ui-container">'+
					'<div class="ui-inner">'+
						'<div id="droptext_dropbox">'+
							'<div class="relativer">';

	if ('draggable' in document.createElement('span')) {
		plhtml += '<span class="thetext">Click on the Add Files button, or drag and drop files here</span>';
	} else {
		plhtml += '<span class="thetext">Click on the Add Files button</span>';
	}
	...
	plhtml +=
				...
				'</div>' +
				'<table class="plupload_filelist ui-widget-header">' +
					'<tfoot class="plupload_filelist plupload_filelist_footer ui-widget-header">' +
						'<tr>' +
							...
							'<td>' +
								'<div class="plupload_started plupload_hidden"><!-- Hidden -->' +
									'<div class="plupload_cell plupload_upload_status" style="display:none;"></div>' +
							...
							'<td class="plupload_file_size">Total: <span class="plupload_total_file_size">0 kb</span></td>' +
...
$.widget("ui.plupload", {
	...
	_initUploader: function() {
		...
		if (self.options.dragdrop) {
			options.drop_element = 'droptext_dropbox';
		}
		...
		uploader.bind('PostInit', function(up) {
			...
			if (self.options.dragdrop && up.features.dragdrop) {
				self.filelist.parent().addClass('droptext_dropbox');
			}
	...
	*/
	...
	_addFiles: function(files) {
		...
		file_html = '<tr class="plupload_file ui-state-default plupload_file_loading plupload_delete" id="%id%">' +
			'<!-- <td>'+
