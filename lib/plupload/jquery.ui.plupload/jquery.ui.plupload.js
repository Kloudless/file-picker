...
function renderUI(obj) {
	...
	const dropzoneText = ('draggable' in document.createElement('span')) ?
		`<span class="plupload-dropzone__text">
			Click on the Add Files button, or drag and drop files here
		</span>` :
		`<span class="plupload-dropzone__text">
			...
			<div class="ui-widget-content plupload_container">
				<div class="ui-state-default ui-widget-header plupload_header">
					<div class="plupload_header_content">
						...
						<div class="plupload_view_switch">
							...
							<label class="plupload_button" for="${obj.id}_view_list" data-view="list">
								${_('List')}
							</label>
							<input type="radio" id="${obj.id}_view_thumbs" name="view_mode_${obj.id}" />
							<label class="plupload_button" for="${obj.id}_view_thumbs" data-view="thumbs">
								${_('Thumbnails')}
							</label>
						</div>
					</div>
				...
				<table class="plupload_filelist ui-widget-header">
					<thead class="plupload_filelist_header">
						<tr class="plupload-filelist__row">
							<th class="plupload-filelist__header-cell plupload_file_name">
								${_('Filename')}
							</th>
							<th class="plupload-filelist__header-cell plupload_file_size">
								${_('Size')}
							</th>
							<th class="plupload-filelist__header-cell plupload_file_status"
								${_('Status')}
							</th>
							<th class="plupload-filelist__header-cell plupload_file_action">
								&nbsp;
							</th>
						</tr>
					</thead>
				</table>
				<div class="plupload-dropzone">
					<div class="plupload-dropzone__wrapper">
						<div id="plupload-dropzone__area" class="plupload-dropzone__area">
							<div class="plupload-dropzone__content">
								${dropzoneText}
							</div>
						</div>
						<table class="plupload_filelist ui-widget-header">
							<tbody class="plupload_filelist_content"></tbody>
						</table>
					</div>
				</div>
				<table class="plupload_filelist ui-widget-header">
					<tfoot class="plupload_filelist_footer">
						<tr class="plupload-filelist__row">
							<td class="plupload-filelist__footer-cell plupload_file_name">
								<div id="custom-add-container" class="plupload_buttons">
									<a id="custom-add" class="button green custom-add plupload_button plupload_add">
										${_("Add Files")}
									</a>
									<a class="plupload_button plupload__btn-cancel">
										Cancel
									</a>
									<a class="plupload_button plupload__btn-upload">
										Upload
									</a>
									<a class="plupload_button plupload_start">
										${_("Start Upload")}
									</a>
									<a class="plupload_button plupload_stop plupload_hidden">
										${_("Stop Upload")}
									</a>
								</div>
							</td>
							<td class="plupload-filelist__footer-cell">
								<div class="plupload_started plupload_hidden">
									<div class="plupload_upload_status"></div>
							...
							<td class="plupload-filelist__footer-cell plupload_file_status">
								<span class="plupload_total_status">0%</span>
							</td>
							<td class="plupload-filelist__footer-cell plupload_file_size">
								Total: <span class="plupload_total_file_size">0 kb</span>
							</td>
						</tr>
					</tfoot>
				</table>
...
$.widget("ui.plupload", {
	...
	_initUploader: function() {
		...
		if (self.options.dragdrop) {
			options.drop_element = 'plupload-dropzone__area';
		}
		...
		uploader.bind('FilesAdded', function(up, files) {
			$("#plupload-dropzone__area").fadeTo(700,0);
		...
		uploader.bind('FilesRemoved', function(up, files) {
			...
			if (up.files.length) {
				...
				$("#plupload-dropzone__area").fadeTo(700, 1);
			}
	...
	*/
	...
	_handleFileStatus: function(file) {
		...
		switch (file.status) {
			case plupload.DONE:
				actionClass = 'plupload-filelist__row plupload_done';
				iconClass = 'plupload_action_icon ui-icon ui-icon-circle-check';
				break;

			case plupload.FAILED:
				actionClass = 'plupload-filelist__row ui-state-error plupload_failed';
				iconClass = 'plupload_action_icon ui-icon ui-icon-alert';
				break;

			case plupload.QUEUED:
				actionClass = 'plupload-filelist__row plupload_delete';
				iconClass = 'plupload_action_icon ui-icon ui-icon-circle-minus';
				break;

			case plupload.UPLOADING:
				actionClass = 'plupload-filelist__row ui-state-highlight plupload_uploading';
	...
	_addFiles: function(files) {
		...
		file_html = `
			<tr class="plupload-filelist__row plupload_file ui-state-default plupload_file_loading plupload_delete" id="%id%">
				<td class="plupload-filelist__content-cell">
					<div class="plupload_file_name" title="%name%">
						<div class="plupload_file_name_wrapper">
							%name%
						</div>
					</div>
				</td>
				...
				<td class="plupload-filelist__content-cell">
					<div class="plupload_file_status">
						...
						<div class="plupload_file_percent">
							%percent%
						</div>
					</div>
				</td>
				<td class="plupload-filelist__content-cell">
					<div class="plupload_file_action">
						<div class="plupload_action_icon ui-icon ui-icon-circle-minus">
						</div>
					</div>
				</td>
			</tr>
