...
function renderUI(obj) {
				...
				'<table class="plupload_filelist ui-widget-header">' +
					'<thead class="plupload_filelist_header">' +
						'<tr class="plupload-filelist__row">' +
							'<td class="plupload-filelist__header-cell plupload_file_name">' + _('Filename') + '</td>' +
							'<td class="plupload-filelist__header-cell plupload_file_status">' + _('Status') + '</td>' +
							'<td class="plupload-filelist__header-cell plupload_file_size">' + _('Size') + '</td>' +
							'<td class="plupload-filelist__header-cell plupload_file_action">&nbsp;</td>' +
						'</tr>' +
					'</thead>' +
				'</table>'+
	...
	if ('draggable' in document.createElement('span')) {
		plhtml += '<span class="plupload-dropzone__text">Click on the Add Files button, or drag and drop files here</span>';
	} else {
		plhtml += '<span class="plupload-dropzone__text">Click on the Add Files button</span>';
	}
						...
						'<tr class="plupload-filelist__row">' +
							'<td class="plupload-filelist__footer-cell plupload_file_name">' +
								'<div id="custom-add-container" class="plupload_buttons">' +
									'<a id="custom-add" class="button green custom-add plupload_button plupload_add">' + _("Add Files") + '</a>&nbsp;' +
							...
							'<td class="plupload-filelist__footer-cell">' +
								...
								'</div>' +
							'</td>' +
							'<td class="plupload-filelist__footer-cell plupload_file_status"><span class="plupload_total_status">0%</span></td>' +
							'<td class="plupload-filelist__footer-cell plupload_file_size">Total: <span class="plupload_total_file_size">0 kb</span></td>' +
...
$.widget("ui.plupload", {
	...
	*/
	...
	_addFiles: function(files) {
		...
		file_html = '<tr class="plupload-filelist__row plupload_file ui-state-default plupload_file_loading plupload_delete" id="%id%">' +
			'<!-- <td>'+
			...
			'<td class="plupload-filelist__content-cell">'+
				'<div class="plupload_file_name" title="%name%">' +
					'<div class="plupload_file_name_wrapper">%name% </div>' +
				'</div>' +
			'</td>'+
			'<td class="plupload-filelist__content-cell">'+
				'<div class="plupload_file_status">' +
					...
					'</div>' +
					'<div class="plupload_file_percent">%percent% </div>' +
				'</div>' +
			'</td>'+
			'<td class="plupload-filelist__content-cell">'+
