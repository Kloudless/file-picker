    ...
    f.core = {
        ...
        selectAll: function(p,o) {
            p.on('mouseover', function (event) {
                if (o.selectAllExclude && $(o.selectAllExclude).has(event.target).length > 0) {
                    return;
                }
    ...
    f.detect = {
        ...
        touch: function() {
            return !!('ontouchstart' in window) // works on most browsers
                /**
                 * kloudless patch:
                 * !!('onmsgesturechange' in window) will return true
                 * even for non-touch IE 10+. Use the trick suggested in
                 * https://github.com/benhowdle89/touche/issues/10 instead
                 */
