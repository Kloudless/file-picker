...
The command will generate production build with minification. The output files
will be in `/dist` folder.
...
EXPLORER_URL | URL for the explorer page | https://static-cdn.kloudless.com/p/platform/explorer/explorer.html

### Testing

To test the build generated by `npm run build`, run the following:
